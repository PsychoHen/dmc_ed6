...
# https://<databricks-instance>#secrets/createScope holiiii
...
dbutils.secrets.list(scope="scope_Postgre_Antony")

# COMMAND ----------

password = dbutils.secrets.get(scope="scope_Postgre_Antony", key="secreto-postgre-dev")
